...
public class GeneradorNivel : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            // Aquí puedes agregar código para generar más partes del nivel
        }
    }
    ...
    private void GenerarParteNivel()
{
    ...
    puntoFinal = nivel.transform.Find("PuntoFinal"); // Asignar el siguiente puntoFinal dentro de la nueva parte del nivel
}
